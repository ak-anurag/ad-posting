                        ...
                        <div class="featured-wrap">
                            <div class="featured-inner">
                                <figure class="item-thumb">
                                    <a class="hover-effect" href="{{ route('adlist.category', ['category' => 'callgirl']) }}">
                                        <img src="assets/img/features/img-1.jpg" alt="">
                                    </a>
                                </figure>
                                <div class="item-body">
                                    <h3 class="job-title"><a href="{{ route('adlist.category', ['category' => 'callgirl']) }}">Call Girls</a></h3>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="featured-item">
                        <div class="featured-wrap">
                            <div class="featured-inner">
                                <figure class="item-thumb">
                                    <a class="hover-effect" href="{{ route('adlist.category', ['category' => 'massages']) }}">
                                        <img src="assets/img/features/img-2.jpg" alt="">
                                    </a>
                                </figure>
                                <div class="item-body">
                                    <h3 class="job-title"><a href="{{ route('adlist.category', ['category' => 'massages']) }}">Massagees</a></h3>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="featured-item">
                        <div class="featured-wrap">
                            <div class="featured-inner">
                                <figure class="item-thumb">
                                    <a class="hover-effect" href="{{ route('adlist.category', ['category' => 'male-escorts']) }}">
                                        <img src="assets/img/features/img-3.jpg" alt="">
                                    </a>
                                </figure>
                                <div class="item-body">
                                    <h3 class="job-title"><a href="{{ route('adlist.category', ['category' => 'male-escorts']) }}">Male Escorts</a></h3>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="featured-item">
                        <div class="featured-wrap">
                            <div class="featured-inner">
                                <figure class="item-thumb">
                                    <a class="hover-effect" href="{{ route('adlist.category', ['category' => 'transsexual']) }}">
                                        <img src="assets/img/features/img-3.jpg" alt="">
                                    </a>
                                </figure>
                                <div class="item-body">
                                    <h3 class="job-title"><a href="{{ route('adlist.category', ['category' => 'transsexual']) }}">Transsexual</a></h3>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="featured-item">
                        <div class="featured-wrap">
                            <div class="featured-inner">
                                <figure class="item-thumb">
                                    <a class="hover-effect" href="{{ route('adlist.category', ['category' => 'adult-meetings']) }}">
                                        <img src="assets/img/features/img-2.jpg" alt="">
                                    </a>
                                </figure>
                                <div class="item-body">
                                    <h3 class="job-title"><a href="{{ route('adlist.category', ['category' => 'adult-meetings']) }}">Adult Meetings</a></h3>
